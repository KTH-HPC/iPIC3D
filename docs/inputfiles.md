...
An input file of a small example:
```yaml
...
The testGEM2Dsmall case should give an output of RhoE for particle 0 similar to this after 3000 cycles.

![image info](/img/testGEM2Dsmall_rhoe0_64x32_3000.png)
