...
void WriteFieldsVTK_noa(Grid3DCU *grid, EMfields3D *EMf, CollectiveIO *col, VCtopology3D *vct, const string & outputTag ,int cycle,float**** fieldwritebuffer){
	...
	string container_name = col->getSimName() + "_" + to_string(cycle);
	string metadata_path  = col->getSaveDirName() + "/metadata";
	container *bucket;
	int rc = noa_container_open(&bucket, container_name.c_str(), metadata_path.c_str(), col->getSaveDirName().c_str());
	...
	for(int tagid=0; tagid<tagsize; tagid++){
		...
		if (fieldtags[tagid].compare("B") == 0){
			...
			sprintf(header, "# vtk DataFile Version 2.0\n"
					...
					"SPACING %f %f %f\n"
					"POINT_DATA %d\n"
					"VECTORS B float\n", nxn-3,nyn-3,nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY, (float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3));
...
void WriteMomentsVTK_noa(Grid3DCU *grid, EMfields3D *EMf, CollectiveIO *col, VCtopology3D *vct, const string & outputTag ,int cycle, float*** momentswritebuffer){
		...
		for(int si=0;si<ns;si++){
			...
			if (momentstags[tagid].compare("rho") == 0){
				...
				sprintf(header, "# vtk DataFile Version 2.0\n"
						...
						"POINT_DATA %d \n"
						"SCALARS %s float\n"
						"LOOKUP_TABLE default\n",(si%2==0)?"Electron":"Ion",si, nxn-3, nyn-3, nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY, (float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3),(si%2==0)?"rhoe":"rhoi");
				...
				sprintf(header, "# vtk DataFile Version 2.0\n"
						...
						"POINT_DATA %d \n"
						"SCALARS %s float\n"
						"LOOKUP_TABLE default\n",(si%2==0)?"Electron":"Ion",si, nxn-3, nyn-3, nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY,(float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3),(si%2==0)?"PXXe":"PXXi");
				...
				sprintf(header, "# vtk DataFile Version 2.0\n"
						...
						"POINT_DATA %d \n"
						"SCALARS %s float\n"
						"LOOKUP_TABLE default\n",(si%2==0)?"Electron":"Ion",si, nxn-3, nyn-3, nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY,(float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3),(si%2==0)?"PXYe":"PXYi");
				...
				sprintf(header, "# vtk DataFile Version 2.0\n"
						...
						"POINT_DATA %d \n"
						"SCALARS %s float\n"
						"LOOKUP_TABLE default\n",(si%2==0)?"Electron":"Ion",si, nxn-3, nyn-3, nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY,(float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3),(si%2==0)?"PXZe":"PXZi");
				...
				sprintf(header, "# vtk DataFile Version 2.0\n"
						...
						"POINT_DATA %d \n"
						"SCALARS %s float\n"
						"LOOKUP_TABLE default\n",(si%2==0)?"Electron":"Ion",si, nxn-3, nyn-3, nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY,(float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3),(si%2==0)?"PYYe":"PYYi");
				...
				sprintf(header, "# vtk DataFile Version 2.0\n"
						...
						"POINT_DATA %d \n"
						"SCALARS %s float\n"
						"LOOKUP_TABLE default\n",(si%2==0)?"Electron":"Ion",si, nxn-3, nyn-3, nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY,(float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3),(si%2==0)?"PYZe":"PYZi");
				...
				sprintf(header, "# vtk DataFile Version 2.0\n"
						...
						"POINT_DATA %d \n"
						"SCALARS %s float\n"
						"LOOKUP_TABLE default\n",(si%2==0)?"Electron":"Ion",si, nxn-3, nyn-3, nzn-3, (float)((nxn-3)*vct->getCoordinates(0))*spaceX, (float)((nyn-3)*vct->getCoordinates(1))*spaceY,(float)((nzn-3)*vct->getCoordinates(2))*spaceZ, spaceX,spaceY,spaceZ, (nxn-3)*(nyn-3)*(nzn-3),(si%2==0)?"PZZe":"PZZi");
			}
